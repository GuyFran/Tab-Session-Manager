...
**Last reassessed:** 2026-08-28; current version **7.4.24**; dev build verified clean and the
...
| Dev build (`webpack.config.dev.js`) | ✅ v7.4.24: 0 errors, 27 warnings (26 upstream `moment` dynamic-locale requires plus the debug stylesheet's Sass-loader deprecation) — produces `dev/chrome` + `dev/firefox` |
